...
public final class QueryUtils {
     ...
     * (for use the makeHttpRequest() method)
     */
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // which represents a list of responses from the API.
            JSONObject response = baseJsonResponse.getJSONObject("response");

            // Extract the JSONArray associated with the key called "results",
            // which represents a list of results from the API
            JSONArray newsArray = response.getJSONArray("results");

            // For each news object in the newsArray, create a {@link News} object
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // For a given response, extract the JSONObject associated with the
                ...
                // For each object in the tagArray, create a {@link News} object
                for (int j = 0; j < tagsArray.length(); j++) {
                    ...
                    // Create a new News object with webTitle, trailText, time
                    // and url from the JSON response.
                    News newsObject2 = new News(webTitle, author, trailText, sectionId, time, url);

                    // Add the new {@link News} to the list of news.
                    newsList.add(newsObject2);
                }
            }
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> newsObject1 = extractFeatureFromJson(jsonResponse);
